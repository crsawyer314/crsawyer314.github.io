                                ...
                                {/* <!-- Banner --> */}
                                    <section id="banner">
                                        <div className="content">
                                            ...
                                            <p>Whether it is grade-school students wanting to learn a new hobby or adults looking to break into tech, there is a space for everyone to learn to code. I host some personal projects on this website, including my <a href="js_course.html">JavaScript for Adult Beginners</a>, a course targeted at adults looking to upskill and learn code.</p>
                                            ...
                                            <ul className="actions">
                                                <li><a href="bio.html" className="button big">Learn More</a></li>
                                            </ul>
                                        </div>
